...
instance SceneNode        "HUD" "Message" where
  type SceneNodeType      "HUD" "Message" = Label
  type SceneNodeName      "HUD" "Message" = "Message"
  type SceneNodeIsHaskell "HUD" "Message" = 'Nothing
